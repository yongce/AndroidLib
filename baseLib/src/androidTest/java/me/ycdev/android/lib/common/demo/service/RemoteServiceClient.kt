...
class RemoteServiceClient(@NonNull context: Context) : ServiceClientBase<IDemoService>(
    context,
    SERVICE_NAME,
    ThreadManager.instance.remoteServiceRequestIpcLooper(),
    RemoteServiceConnector(context)
) {
    companion object {
