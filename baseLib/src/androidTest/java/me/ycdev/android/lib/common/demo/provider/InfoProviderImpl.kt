...
class InfoProviderImpl : InfoProvider() {
    ...
    override fun get(
        @NonNull table: String,
        @NonNull name: String
    ): String? = getStoragePrefs(table).getString(name, null)
    ...
    private fun getStoragePrefs(table: String): SharedPreferences = context!!.getSharedPreferences("info_provider_$table", Context.MODE_PRIVATE)
}
